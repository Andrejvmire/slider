...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractModelPublisher; });
/* harmony import */ var _AbstractPublisher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AbstractPublisher */ "./src/ts/abstract/AbstractPublisher.ts");

class AbstractModelPublisher extends _AbstractPublisher__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super(...arguments);
        this._eventType = "modelEvent";
    }
    attach(subscriber) {
...
/***/ "./src/ts/abstract/AbstractPublisher.ts":
/*!**********************************************!*\
  !*** ./src/ts/abstract/AbstractPublisher.ts ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/ts/abstract/AbstractViewPublisher.ts":
/*!**************************************************!*\
  !*** ./src/ts/abstract/AbstractViewPublisher.ts ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractViewPublisher; });
/* harmony import */ var _AbstractPublisher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AbstractPublisher */ "./src/ts/abstract/AbstractPublisher.ts");

class AbstractViewPublisher extends _AbstractPublisher__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super(...arguments);
        this._eventType = "viewEvent";
    }
    attach(subscriber) {
        super.attach(subscriber, this._eventType);
    }
...
/* harmony import */ var _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract/AbstractModelPublisher */ "./src/ts/abstract/AbstractModelPublisher.ts");

class PointModel extends _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(_position, subscriber) {
        super();
...
/* harmony import */ var _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../abstract/AbstractModelPublisher */ "./src/ts/abstract/AbstractModelPublisher.ts");


class PointsModel extends _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    move(to, from) {
        ...
        if (typeof from === "undefined") {
            this._points
                ...
                const absCurrVal = Math.abs(currentValue.state - to), absPrevValue = Math.abs(previousValue.state - to);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RulerModel; });
class RulerModel {
    constructor(options) {
        this._min = options[0];
        this._max = options[1];
...
/* harmony import */ var _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract/AbstractModelPublisher */ "./src/ts/abstract/AbstractModelPublisher.ts");
/* harmony import */ var _RulerModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RulerModel */ "./src/ts/models/RulerModel.ts");
...
/* harmony import */ var _Validator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Validator */ "./src/ts/models/Validator.ts");
/* harmony import */ var _ValidationErrors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ValidationErrors */ "./src/ts/models/ValidationErrors.ts");





class SliderModel extends _abstract_AbstractModelPublisher__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(options) {
        super();
        this._ruler = new _RulerModel__WEBPACK_IMPORTED_MODULE_1__["default"](options.ruler);
        this._points = new _PointsModel__WEBPACK_IMPORTED_MODULE_2__["default"](options.points, options.step);
        this.inRangeValidate();
        this._points.attach(this);
    }
    inRangeValidate(points) {
        const point = points || this._points;
        this._validator = _Validator__WEBPACK_IMPORTED_MODULE_3__["default"].inRange(this._ruler, point);
        if (!this._validator.valid) {
            new _ValidationErrors__WEBPACK_IMPORTED_MODULE_4__["default"](this._validator);
        }
    }
    update(data) {
        this.notify(data);
...
/***/ "./src/ts/models/ValidationErrors.ts":
/*!*******************************************!*\
  !*** ./src/ts/models/ValidationErrors.ts ***!
  \*******************************************/
/*! exports provided: default */
...
class Validator {
    ...
    static inRange(ruler, points) {
        let model = new Validator(), { min, max } = ruler.state, values = [];
        if (typeof points === "number") {
            values.push(points);
        }
        else {
            values = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.concat(values, points.state);
        }
        values
            .map(point => {
...
RulerView.className = 'slider slider__ruler';
...
class SliderView extends _abstract_AbstractViewPublisher__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(options, parent) {
        super();
        this.options = options;
        this.parent = parent;
